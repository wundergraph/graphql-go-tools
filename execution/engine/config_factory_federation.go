...
func NewFederationEngineConfigFactory(dataSourceConfigs []graphql_datasource.Configuration, opts ...FederationEngineConfigFactoryOption) *FederationEngineConfigFactory {
...
type FederationEngineConfigFactory struct {
	httpClient                *http.Client
	streamingClient           *http.Client
	dataSourceConfigs         []graphql_datasource.Configuration
...
func (f *FederationEngineConfigFactory) engineConfigFieldConfigs(schema *graphql.Schema) (plan.FieldConfigurations, error) {
