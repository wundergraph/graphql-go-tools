...
require (
	...
	github.com/TykTechnologies/graphql-go-tools/examples/chat v0.0.0-20220623103043-073ac8dc733a
	github.com/TykTechnologies/graphql-go-tools/examples/federation v0.0.0-20220623103043-073ac8dc733a
