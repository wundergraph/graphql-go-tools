...
func (ec *executionContext) _Chatroom_messages(ctx context.Context, field graphql.CollectedField, obj *Chatroom) (ret graphql.Marshaler) {
	...
	res := resTmp.([]Message)
	fc.Result = res
	return ec.marshalNMessage2ᚕgithubᚗcomᚋwundergraphᚋgraphqlᚑgoᚑtoolsᚋtestappsᚋchatᚐMessageᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_post(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*Message)
	fc.Result = res
	return ec.marshalNMessage2ᚖgithubᚗcomᚋwundergraphᚋgraphqlᚑgoᚑtoolsᚋtestappsᚋchatᚐMessage(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_room(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*Chatroom)
	fc.Result = res
	return ec.marshalOChatroom2ᚖgithubᚗcomᚋwundergraphᚋgraphqlᚑgoᚑtoolsᚋtestappsᚋchatᚐChatroom(ctx, field.Selections, res)
}
	...
	return func(ctx context.Context) graphql.Marshaler {
		...
		case res, ok := <-resTmp.(<-chan *Message):
			...
			return graphql.WriterFunc(func(w io.Writer) {
				...
				w.Write([]byte{':'})
				ec.marshalNMessage2ᚖgithubᚗcomᚋwundergraphᚋgraphqlᚑgoᚑtoolsᚋtestappsᚋchatᚐMessage(ctx, field.Selections, res).MarshalGQL(w)
				w.Write([]byte{'}'})
			})
		case <-ctx.Done():
			return nil
...
func (ec *executionContext) marshalNMessage2githubᚗcomᚋwundergraphᚋgraphqlᚑgoᚑtoolsᚋtestappsᚋchatᚐMessage(ctx context.Context, sel ast.SelectionSet, v Message) graphql.Marshaler {
	return ec._Message(ctx, sel, &v)
}

func (ec *executionContext) marshalNMessage2ᚕgithubᚗcomᚋwundergraphᚋgraphqlᚑgoᚑtoolsᚋtestappsᚋchatᚐMessageᚄ(ctx context.Context, sel ast.SelectionSet, v []Message) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMessage2githubᚗcomᚋwundergraphᚋgraphqlᚑgoᚑtoolsᚋtestappsᚋchatᚐMessage(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMessage2ᚖgithubᚗcomᚋwundergraphᚋgraphqlᚑgoᚑtoolsᚋtestappsᚋchatᚐMessage(ctx context.Context, sel ast.SelectionSet, v *Message) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOChatroom2ᚖgithubᚗcomᚋwundergraphᚋgraphqlᚑgoᚑtoolsᚋtestappsᚋchatᚐChatroom(ctx context.Context, sel ast.SelectionSet, v *Chatroom) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
