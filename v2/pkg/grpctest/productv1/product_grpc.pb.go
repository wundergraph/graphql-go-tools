...
func (c *productServiceClient) LookupResourceById(ctx context.Context, in *LookupResourceByIdRequest, opts ...grpc.CallOption) (*LookupResourceByIdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LookupResourceByIdResponse)
	err := c.cc.Invoke(ctx, ProductService_LookupResourceById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProductServiceServer) LookupResourceById(context.Context, *LookupResourceByIdRequest) (*LookupResourceByIdResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method LookupResourceById not implemented")
}
...
func _ProductService_LookupResourceById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LookupResourceByIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).LookupResourceById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_LookupResourceById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).LookupResourceById(ctx, req.(*LookupResourceByIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProductService_LookupResourceById_Handler,
		},
		{
