...
// Source: github.com/wundergraph/graphql-go-tools/v2/pkg/engine/resolve (interfaces: DataSource,BeforeFetchHook,AfterFetchHook,DataSourceBatch,DataSourceBatchFactory)
...
import (
	...
	fastbuffer "github.com/wundergraph/graphql-go-tools/v2/pkg/fastbuffer"
)
