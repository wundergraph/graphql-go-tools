...
var (
	...
	// Deprecated: use ErrInvalidSubscriptionFilterTemplate.
	//lint:ignore ST1012 keep alias for backwards compatibility
	InvalidSubscriptionFilterTemplate = ErrInvalidSubscriptionFilterTemplate
)
