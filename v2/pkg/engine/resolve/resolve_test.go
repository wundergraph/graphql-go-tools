...
func (f *_fakeStream) TriggerIDInput(_ *Context, input []byte, xxh *xxhash.Digest) error {
...
func (s *startFailStream) TriggerIDInput(_ *Context, input []byte, xxh *xxhash.Digest) error {
	_, err := xxh.Write(input)
	return err
}
...
func (s *hookFailStream) TriggerIDInput(_ *Context, input []byte, xxh *xxhash.Digest) error {
	_, err := xxh.Write(input)
	return err
}
