				...
				Fetches: resolve.Sequence(
					resolve.Single(&resolve.SingleFetch{
						FetchConfiguration: resolve.FetchConfiguration{
							Input:          `{"method":"POST","url":"http://accounts.service","body":{"query":"{accounts {__typename ... on User {__sg_merge_User_id: id name} ... on Admin {__sg_merge_Admin_id: id name}}}"}}`,
									...
									Fields: []*resolve.Field{
										{
											...
											Value: &resolve.Scalar{
												Path:     []string{"__sg_merge_User_id"},
												Nullable: true,
											},
										...
										},
										{
											Name: []byte("id"),
											Value: &resolve.Scalar{
												Path:     []string{"__sg_merge_Admin_id"},
												Nullable: true,
											},
