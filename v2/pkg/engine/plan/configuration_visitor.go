...
func (c *configurationVisitor) handlePlanningField(fieldRef int, typeName, fieldName, currentPath, parentPath, precedingParentPath string, suggestion *NodeSuggestion, ds DataSource, shareable bool) {
...
func (c *configurationVisitor) addNewPlanner(fieldRef int, typeName, fieldName, currentPath, parentPath string, isMutationRoot bool, dsConfig DataSource) (plannerIdx int, planned bool) {
...
func (c *configurationVisitor) isSubscriptionRoot(path string) bool {
...
func (c *configurationVisitor) isMutationRoot(path string) bool {
	root := c.walker.Ancestors[0]
...
func (c *configurationVisitor) isNotOperationDefinitionRoot() bool {
