...
type Configuration struct {
	...
	// RelaxSubgraphOperationFieldSelectionMergingTypeMismatch relaxes the type mismatch
	// validation for field selection merging in upstream (subgraph) operations when enclosing
	// types are non-overlapping concrete object types. This is a deliberate spec deviation.
	// When true, factories that support it will allow completely different types
